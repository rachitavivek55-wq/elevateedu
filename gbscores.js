...
(function () {
  ...
  function injectCSS() {
    ...
    css.textContent = [
      ...
      '.gb-grades-sec{margin-top:6px;border-top:1px solid rgba(69,82,97,.14);padding-top:16px;}',
      '.gb-grades-sec[hidden]{display:none !important;}',
      '.gb-grades-head{display:flex;align-items:center;gap:8px;margin-bottom:10px;}',
      '.gb-grades-head h4{margin:0;font:700 14.5px/1 Poppins,sans-serif;color:#383e45;}',
      '.gb-grades-head .gb-gr-avg{margin-left:auto;font:700 13px/1 Poppins,sans-serif;color:#455261;background:rgba(69,82,97,.10);padding:5px 10px;border-radius:10px;}',
      '.gb-grades-hint{font:400 11.5px/1.5 Poppins,sans-serif;color:#6d7680;margin:0 0 12px;}',
      '.gb-cat{border-radius:14px;background:rgba(183,194,207,.20);padding:11px 12px;margin-bottom:10px;}',
      '.gb-cat-head{display:flex;align-items:center;gap:8px;}',
      '.gb-cat-name{font:600 13.5px/1.2 Poppins,sans-serif;color:#383e45;}',
      '.gb-cat-wt{font:500 11px/1 Poppins,sans-serif;color:#6d7680;background:rgba(69,82,97,.10);padding:3px 7px;border-radius:8px;}',
      '.gb-cat-avg{margin-left:auto;font:700 13px/1 Poppins,sans-serif;color:#455261;}',
      '.gb-mini-btn{border:none;background:transparent;color:#6d7680;cursor:pointer;padding:4px;border-radius:8px;display:inline-flex;}',
      '.gb-mini-btn:hover{background:rgba(69,82,97,.10);color:#455261;}',
      '.gb-mini-btn .lucide{width:15px;height:15px;}',
      '.gb-score-list{margin:9px 0 0;display:flex;flex-direction:column;gap:5px;}',
      '.gb-score-row{display:flex;align-items:center;gap:8px;padding:7px 10px;border-radius:10px;background:#fafbfc;}',
      '.gb-score-name{font:500 12.5px/1.3 Poppins,sans-serif;color:#383e45;flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}',
      '.gb-score-val{font:600 12.5px/1 Poppins,sans-serif;color:#455261;}',
      '.gb-add-score{margin-top:9px;border:none;background:transparent;color:#455261;font:600 12px/1 Poppins,sans-serif;cursor:pointer;display:inline-flex;align-items:center;gap:5px;padding:4px 2px;}',
      '.gb-add-score .lucide{width:14px;height:14px;}',
      '.gb-add-cat{width:100%;border:1px dashed rgba(69,82,97,.35);background:transparent;color:#455261;border-radius:12px;padding:10px;font:600 12.5px/1 Poppins,sans-serif;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;margin-top:2px;}',
      '.gb-add-cat:hover{background:rgba(69,82,97,.06);}',
      ...
      '.gb-grades-empty-icon{display:flex;align-items:center;justify-content:center;width:50px;height:50px;border-radius:16px;background:rgba(69,82,97,.11);margin-bottom:11px;}',
      '.gb-grades-empty-icon svg{width:22px;height:22px;stroke:#6d7680;}',
      '.gb-grades-empty h4{margin:0 0 4px;font:700 14px/1.25 Poppins,sans-serif;color:#383e45;}',
      '.gb-grades-empty p{margin:0;font:500 12px/1.5 Poppins,sans-serif;color:#7a848f;max-width:236px;}',
      /* overlay (second-level, above the class sheet) */
      '.gbsc-backdrop{position:absolute;inset:0;background:rgba(56,62,69,.40);display:flex;align-items:flex-end;justify-content:center;z-index:80;}',
      '.gbsc-backdrop[hidden]{display:none !important;}',
      '.gbsc-sheet{width:100%;max-height:88%;overflow:auto;background:#dadfe5;border-radius:22px 22px 0 0;padding:18px 18px 20px;box-shadow:0 -8px 30px rgba(56,62,69,.20);}',
      '.gbsc-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;}',
      '.gbsc-head h3{font:700 17px/1.2 Poppins,sans-serif;color:#383e45;margin:0;}',
      '.gbsc-close{border:none;background:#fafbfc;width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;color:#455261;}',
      '.gbsc-close .lucide{width:17px;height:17px;}',
      '.gbsc-label{display:block;font:600 12.5px/1 Poppins,sans-serif;color:#455261;margin:0 0 6px;}',
      '.gbsc-hint{font-weight:400;color:#6d7680;font-size:11px;}',
      '.gb-gr-mode{display:flex;flex-wrap:wrap;align-items:center;gap:6px;margin:0 0 10px;}',
      '.gb-gr-mbtn{border:1px solid #cbd2da;background:#f8f9fa;color:#6d7680;font:600 11px/1 Poppins,sans-serif;padding:7px 11px;border-radius:999px;cursor:pointer;}',
      '.gb-gr-mbtn.on{background:#455261;border-color:#455261;color:#fff;}',
      '.gb-gr-mhint{flex:1 1 100%;color:#828b96;font-size:10.5px;line-height:1.4;}',
      '.gbsc-field{margin-bottom:14px;}',
      '.gbsc-input,.gbsc-select{width:100%;box-sizing:border-box;border:1px solid rgba(69,82,97,.20);background:#fafbfc;border-radius:12px;padding:11px 12px;font:500 14px/1.2 Poppins,sans-serif;color:#383e45;}',
      '.gbsc-input:focus,.gbsc-select:focus{outline:none;border-color:#455261;}',
      '.gbsc-seg{display:flex;background:#fafbfc;border-radius:12px;padding:3px;gap:3px;}',
      '.gbsc-seg button{flex:1;border:none;background:transparent;border-radius:9px;padding:8px;font:600 12.5px/1 Poppins,sans-serif;color:#6d7680;cursor:pointer;}',
      '.gbsc-seg button.active{background:#455261;color:#fafbfc;}',
      '.gbsc-points{display:flex;align-items:center;gap:8px;}',
      '.gbsc-points span{color:#6d7680;font:600 14px/1 Poppins,sans-serif;}',
      ...
      '.gbsc-btn.ghost{background:#fafbfc;color:#383e45;}',
      '.gbsc-btn.primary{background:#455261;color:#fafbfc;}',
      ...
      '.gbsc-chip{border:1px solid rgba(69,82,97,.25);background:#fafbfc;color:#455261;border-radius:999px;padding:7px 13px;font:600 12px/1 Poppins,sans-serif;cursor:pointer;}',
      '.gbsc-chip:hover{background:rgba(69,82,97,.08);}',
    ].join('');
  ...
  function confirmSheet(msg, onYes) {
    var wrap = document.createElement('div');
    wrap.innerHTML =
      '<p style="font:500 14px/1.5 Poppins,sans-serif;color:#383e45;margin:0 0 16px;">' +
      esc(msg) +
      '</p>' +
  ...
  (function () {
    ...
    st.textContent =
      '/* layout fixes */.gb-class-main{display:flex !important;flex-direction:column !important;gap:3px !important;min-width:0 !important;}.gb-class-name{display:block !important;font-weight:600 !important;}.gb-class-sub{display:block !important;font-size:11.5px !important;color:#7a848f !important;line-height:1.2 !important;}/* class edit sheet: compact so form + grades fit */#gbSheet{max-height:90% !important;padding:18px 18px 22px !important;}#gbForm{display:flex;flex-direction:column;gap:11px !important;}#gbForm label,#gbForm .gb-field{margin:0 !important;}#gbSheet h3{margin-bottom:6px !important;}/* grades section spacing */#gbGradesSec{margin-top:16px !important;padding-top:16px !important;border-top:1px solid rgba(69,82,97,.15) !important;}';
  ...
  function gbInjectPageCSS() {
    ...
    st.textContent = [
      ...
      '.gbcp-back{display:inline-flex;align-items:center;gap:5px;border:none;background:transparent;color:#455261;font:600 13px/1 Poppins,sans-serif;cursor:pointer;padding:4px 2px;}',
      ...
      '.gbcp-title{font:700 23px/1.15 Poppins,sans-serif;color:#383e45;margin:0;word-break:break-word;}',
      '.gbcp-grade{flex:0 0 auto;background:#d6dbe1;color:#455261;border-radius:999px;padding:7px 13px;font:700 13px/1 Poppins,sans-serif;white-space:nowrap;}',
      '.gbcp-teacher{color:#7a848f;font:500 13px/1.3 Poppins,sans-serif;margin:0 0 12px;}',
      '.gbcp-titleside{display:flex;align-items:center;gap:8px;flex:0 0 auto;}',
      '.gbcp-edit{display:inline-flex;align-items:center;gap:6px;border:1px solid rgba(69,82,97,.25);background:#fafbfc;color:#455261;border-radius:999px;padding:8px 13px;font:600 12.5px/1 Poppins,sans-serif;cursor:pointer;}',
      '.gbcp-edit .lucide{width:16px;height:16px;}',
      '.gbcp-instr{background:transparent;border:none;padding:0 2px;color:#7a848f;font:500 12.5px/1.5 Poppins,sans-serif;margin:0 0 18px;}',
      ...
      '.gbcp-calc{background:#d6dbe1;border-radius:16px;padding:15px 16px;margin:2px 0 14px;}',
      '.gbcp-calc-row{display:flex;align-items:baseline;justify-content:space-between;gap:10px;}',
      '.gbcp-calc-lbl{color:#5d6670;font:600 12.5px/1 Poppins,sans-serif;}',
      '.gbcp-calc-val{color:#383e45;font:700 17px/1 Poppins,sans-serif;text-align:right;}',
      '.gbcp-set-lbl{display:block;color:#5d6670;font:600 12px/1.3 Poppins,sans-serif;margin-bottom:8px;}',
      '.gbcp-set-row{display:flex;gap:8px;margin-bottom:10px;}',
      '.gbcp-set-type{flex:0 0 auto;border:1px solid rgba(69,82,97,0.22);background:#fafbfc;color:#383e45;border-radius:10px;padding:9px 10px;font:600 12.5px/1 Poppins,sans-serif;cursor:pointer;}',
      '.gbcp-set-val{flex:1 1 auto;min-width:0;border:1px solid rgba(69,82,97,0.22);background:#fafbfc;color:#383e45;border-radius:10px;padding:9px 11px;font:500 13px/1 Poppins,sans-serif;}',
      '.gbcp-set-val:disabled{opacity:0.5;}',
      '.gbcp-set-actions{display:flex;gap:8px;}',
      '.gbcp-usecalc{flex:1 1 auto;border:1px solid rgba(69,82,97,0.3);background:transparent;color:#455261;border-radius:10px;padding:9px 10px;font:600 12.5px/1 Poppins,sans-serif;cursor:pointer;}',
      '.gbcp-save{flex:1 1 auto;border:none;background:#455261;color:#fafbfc;border-radius:10px;padding:9px 10px;font:600 12.5px/1 Poppins,sans-serif;cursor:pointer;}',
