...
(function () {
  ...
  function injectCSS() {
    ...
    css.textContent = [
      ...
      '.gb-grades-sec{margin-top:6px;border-top:1px solid rgba(103,80,63,.14);padding-top:16px;}',
      '.gb-grades-sec[hidden]{display:none !important;}',
      '.gb-grades-head{display:flex;align-items:center;gap:8px;margin-bottom:10px;}',
      '.gb-grades-head h4{margin:0;font:700 14.5px/1 Poppins,sans-serif;color:#473a36;}',
      '.gb-grades-head .gb-gr-avg{margin-left:auto;font:700 13px/1 Poppins,sans-serif;color:#67503f;background:rgba(103,80,63,.10);padding:5px 10px;border-radius:10px;}',
      '.gb-grades-hint{font:400 11.5px/1.5 Poppins,sans-serif;color:#847669;margin:0 0 12px;}',
      '.gb-cat{border-radius:14px;background:rgba(212,196,177,.20);padding:11px 12px;margin-bottom:10px;}',
      '.gb-cat-head{display:flex;align-items:center;gap:8px;}',
      '.gb-cat-name{font:600 13.5px/1.2 Poppins,sans-serif;color:#473a36;}',
      '.gb-cat-wt{font:500 11px/1 Poppins,sans-serif;color:#847669;background:rgba(103,80,63,.10);padding:3px 7px;border-radius:8px;}',
      '.gb-cat-avg{margin-left:auto;font:700 13px/1 Poppins,sans-serif;color:#67503f;}',
      '.gb-mini-btn{border:none;background:transparent;color:#847669;cursor:pointer;padding:4px;border-radius:8px;display:inline-flex;}',
      '.gb-mini-btn:hover{background:rgba(103,80,63,.10);color:#67503f;}',
      '.gb-mini-btn .lucide{width:15px;height:15px;}',
      '.gb-score-list{margin:9px 0 0;display:flex;flex-direction:column;gap:5px;}',
      '.gb-score-row{display:flex;align-items:center;gap:8px;padding:7px 10px;border-radius:10px;background:#fefcf8;}',
      '.gb-score-name{font:500 12.5px/1.3 Poppins,sans-serif;color:#473a36;flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}',
      '.gb-score-val{font:600 12.5px/1 Poppins,sans-serif;color:#67503f;}',
      '.gb-add-score{margin-top:9px;border:none;background:transparent;color:#67503f;font:600 12px/1 Poppins,sans-serif;cursor:pointer;display:inline-flex;align-items:center;gap:5px;padding:4px 2px;}',
      '.gb-add-score .lucide{width:14px;height:14px;}',
      '.gb-add-cat{width:100%;border:1px dashed rgba(103,80,63,.35);background:transparent;color:#67503f;border-radius:12px;padding:10px;font:600 12.5px/1 Poppins,sans-serif;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;margin-top:2px;}',
      '.gb-add-cat:hover{background:rgba(103,80,63,.06);}',
      ...
      '.gb-grades-empty-icon{display:flex;align-items:center;justify-content:center;width:50px;height:50px;border-radius:16px;background:rgba(103,80,63,.11);margin-bottom:11px;}',
      '.gb-grades-empty-icon svg{width:22px;height:22px;stroke:#847669;}',
      '.gb-grades-empty h4{margin:0 0 4px;font:700 14px/1.25 Poppins,sans-serif;color:#473a36;}',
      '.gb-grades-empty p{margin:0;font:500 12px/1.5 Poppins,sans-serif;color:#948576;max-width:236px;}',
      /* overlay (second-level, above the class sheet) */
      '.gbsc-backdrop{position:absolute;inset:0;background:rgba(71,58,54,.40);display:flex;align-items:flex-end;justify-content:center;z-index:80;}',
      '.gbsc-backdrop[hidden]{display:none !important;}',
      '.gbsc-sheet{width:100%;max-height:88%;overflow:auto;background:#efe3d0;border-radius:22px 22px 0 0;padding:18px 18px 20px;box-shadow:0 -8px 30px rgba(71,58,54,.20);}',
      '.gbsc-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;}',
      '.gbsc-head h3{font:700 17px/1.2 Poppins,sans-serif;color:#473a36;margin:0;}',
      '.gbsc-close{border:none;background:#fefcf8;width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;color:#67503f;}',
      '.gbsc-close .lucide{width:17px;height:17px;}',
      '.gbsc-label{display:block;font:600 12.5px/1 Poppins,sans-serif;color:#67503f;margin:0 0 6px;}',
      '.gbsc-hint{font-weight:400;color:#847669;font-size:11px;}',
      '.gb-gr-mode{display:flex;flex-wrap:wrap;align-items:center;gap:6px;margin:0 0 10px;}',
      '.gb-gr-mbtn{border:1px solid #ddd3c8;background:#fdf9f5;color:#847669;font:600 11px/1 Poppins,sans-serif;padding:7px 11px;border-radius:999px;cursor:pointer;}',
      '.gb-gr-mbtn.on{background:#67503f;border-color:#67503f;color:#fff;}',
      '.gb-gr-mhint{flex:1 1 100%;color:#9a8d7e;font-size:10.5px;line-height:1.4;}',
      '.gbsc-field{margin-bottom:14px;}',
      '.gbsc-input,.gbsc-select{width:100%;box-sizing:border-box;border:1px solid rgba(103,80,63,.20);background:#fefcf8;border-radius:12px;padding:11px 12px;font:500 14px/1.2 Poppins,sans-serif;color:#473a36;}',
      '.gbsc-input:focus,.gbsc-select:focus{outline:none;border-color:#67503f;}',
      '.gbsc-seg{display:flex;background:#fefcf8;border-radius:12px;padding:3px;gap:3px;}',
      '.gbsc-seg button{flex:1;border:none;background:transparent;border-radius:9px;padding:8px;font:600 12.5px/1 Poppins,sans-serif;color:#847669;cursor:pointer;}',
      '.gbsc-seg button.active{background:#67503f;color:#fefcf8;}',
      '.gbsc-points{display:flex;align-items:center;gap:8px;}',
      '.gbsc-points span{color:#847669;font:600 14px/1 Poppins,sans-serif;}',
      ...
      '.gbsc-btn.ghost{background:#fefcf8;color:#473a36;}',
      '.gbsc-btn.primary{background:#67503f;color:#fefcf8;}',
      ...
      '.gbsc-chip{border:1px solid rgba(103,80,63,.25);background:#fefcf8;color:#67503f;border-radius:999px;padding:7px 13px;font:600 12px/1 Poppins,sans-serif;cursor:pointer;}',
      '.gbsc-chip:hover{background:rgba(103,80,63,.08);}',
    ].join('');
  ...
  function confirmSheet(msg, onYes) {
    var wrap = document.createElement('div');
    wrap.innerHTML =
      '<p style="font:500 14px/1.5 Poppins,sans-serif;color:#473a36;margin:0 0 16px;">' +
      esc(msg) +
      '</p>' +
  ...
  (function () {
    ...
    st.textContent =
      '/* layout fixes */.gb-class-main{display:flex !important;flex-direction:column !important;gap:3px !important;min-width:0 !important;}.gb-class-name{display:block !important;font-weight:600 !important;}.gb-class-sub{display:block !important;font-size:11.5px !important;color:#948576 !important;line-height:1.2 !important;}/* class edit sheet: compact so form + grades fit */#gbSheet{max-height:90% !important;padding:18px 18px 22px !important;}#gbForm{display:flex;flex-direction:column;gap:11px !important;}#gbForm label,#gbForm .gb-field{margin:0 !important;}#gbSheet h3{margin-bottom:6px !important;}/* grades section spacing */#gbGradesSec{margin-top:16px !important;padding-top:16px !important;border-top:1px solid rgba(103,80,63,.15) !important;}';
  ...
  function gbInjectPageCSS() {
    ...
    st.textContent = [
      ...
      '.gbcp-back{display:inline-flex;align-items:center;gap:5px;border:none;background:transparent;color:#67503f;font:600 13px/1 Poppins,sans-serif;cursor:pointer;padding:4px 2px;}',
      ...
      '.gbcp-title{font:700 23px/1.15 Poppins,sans-serif;color:#473a36;margin:0;word-break:break-word;}',
      '.gbcp-grade{flex:0 0 auto;background:#e9dfce;color:#67503f;border-radius:999px;padding:7px 13px;font:700 13px/1 Poppins,sans-serif;white-space:nowrap;}',
      '.gbcp-teacher{color:#948576;font:500 13px/1.3 Poppins,sans-serif;margin:0 0 12px;}',
      '.gbcp-titleside{display:flex;align-items:center;gap:8px;flex:0 0 auto;}',
      '.gbcp-edit{display:inline-flex;align-items:center;gap:6px;border:1px solid rgba(103,80,63,.25);background:#fefcf8;color:#67503f;border-radius:999px;padding:8px 13px;font:600 12.5px/1 Poppins,sans-serif;cursor:pointer;}',
      '.gbcp-edit .lucide{width:16px;height:16px;}',
      '.gbcp-instr{background:transparent;border:none;padding:0 2px;color:#948576;font:500 12.5px/1.5 Poppins,sans-serif;margin:0 0 18px;}',
      ...
      '.gbcp-calc{background:#e9dfce;border-radius:16px;padding:15px 16px;margin:2px 0 14px;}',
      '.gbcp-calc-row{display:flex;align-items:baseline;justify-content:space-between;gap:10px;}',
      '.gbcp-calc-lbl{color:#746559;font:600 12.5px/1 Poppins,sans-serif;}',
      '.gbcp-calc-val{color:#473a36;font:700 17px/1 Poppins,sans-serif;text-align:right;}',
      '.gbcp-set-lbl{display:block;color:#746559;font:600 12px/1.3 Poppins,sans-serif;margin-bottom:8px;}',
      '.gbcp-set-row{display:flex;gap:8px;margin-bottom:10px;}',
      '.gbcp-set-type{flex:0 0 auto;border:1px solid rgba(103,80,63,0.22);background:#fefcf8;color:#473a36;border-radius:10px;padding:9px 10px;font:600 12.5px/1 Poppins,sans-serif;cursor:pointer;}',
      '.gbcp-set-val{flex:1 1 auto;min-width:0;border:1px solid rgba(103,80,63,0.22);background:#fefcf8;color:#473a36;border-radius:10px;padding:9px 11px;font:500 13px/1 Poppins,sans-serif;}',
      '.gbcp-set-val:disabled{opacity:0.5;}',
      '.gbcp-set-actions{display:flex;gap:8px;}',
      '.gbcp-usecalc{flex:1 1 auto;border:1px solid rgba(103,80,63,0.3);background:transparent;color:#67503f;border-radius:10px;padding:9px 10px;font:600 12.5px/1 Poppins,sans-serif;cursor:pointer;}',
      '.gbcp-save{flex:1 1 auto;border:none;background:#67503f;color:#fefcf8;border-radius:10px;padding:9px 10px;font:600 12.5px/1 Poppins,sans-serif;cursor:pointer;}',
