...
// make all-day chips open their entry, just like timed chips
  ...
  function placeEvent(e, date, col, dayCount, startMin, endMin, lane, lanes, capMin) {
    ...
    chip.style.setProperty('--ec', e.color || '#67503f');
  ...
  function resetForm() {
    ...
    document.getElementById('fColor').value = '#67503f';
